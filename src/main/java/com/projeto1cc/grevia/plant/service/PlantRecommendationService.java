...
public class PlantRecommendationService {
    ...
    private String getSpeciesRecommendation(Species species) {
        ...
        return switch (species) {
            ...
            case PIMENTA -> "Pimenta: Área mínima: Vaso 10 L. Colheita: 80-100 dias. Adubo: Húmus. Rega: 1x dia. Dica: Colher quando maduro.";
            ...
            case MILHO_ANAO -> "Milho anão: Área mínima: 1 m². Colheita: 90 dias. Adubo: Composto. Rega: 3x semana. Dica: Plantar in grupo.";
        ...
        return switch (soilType) {
            case ARENOSO -> {
                if (isXerophyte)
                    ...
                    yield "Atenção: plantas tropicais precisam de umidade constante, mas o solo arenoso drena rápido."
                            + " Aumente a frequência de rega e adicione matéria orgânica ao substrato para compensar.";
                else if (isHerb || isVegetable)
                    yield "Atenção: ervas e hortaliças demandam nutrientes e umidade que o solo arenoso não retém bem."
                            + " Enriqueça com composto orgânico e aumente a frequência de rega e adubação.";
                else
                    yield "Considere enriquecer o solo arenoso com matéria orgânica para suprir melhor as necessidades desta planta.";
            }
            case ARGILOSO -> {
                if (isXerophyte)
                    ...
                    yield "Solo argiloso retém umidade que plantas tropicais apreciam, mas cuidado com o encharcamento."
                            + " Garanta buracos de drenagem no vaso e revise o solo periodicamente para evitar compactação.";
                else if (isVegetable)
                    yield "Hortaliças precisam de raízes soltas para crescer bem. No solo argiloso, incorpore composto"
                            + " e areia para aerar o substrato e facilitar o desenvolvimento radicular.";
                else
                    yield "Solo argiloso pode compactar e sufocar raízes. Solte o substrato com areia grossa e certifique-se de boa drenagem no vaso.";
            }
            case HUMOSO -> {
                if (isXerophyte)
                    yield "Solo humoso retém muito mais umidade do que cactos e suculentas toleram."
                            + " Misture areia ou perlita (proporção 1:1) al húmus para garantir que o excesso de água escorra rapidamente.";
            ...
            case CALCARIO -> {
                if (isXerophyte)
                    ...
                    yield "Solo calcário é alcalino e pode dificultar a absorção de nutrientes. Monitore sinais de carência (folhas amarelas) e corrija com matéria orgânica.";
            }
            case MISTO -> {
                if (isXerophyte)
